...
export default function BeautyStore() {
  ...
  return (
    <div className="min-h-screen bg-white" dir="rtl">
      {/* Header - Now sticky with smooth backdrop blur */}
      <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            <button className="p-2 transition hover:text-purple-600">
      ...
      {/* Hero - Improved responsive layout */}
      <section className="container mx-auto grid gap-8 px-4 py-12 lg:grid-cols-2 lg:items-center">
        ...
        <div className="aspect-video overflow-hidden rounded-lg bg-gray-100">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/screencapture-app-webcrumbs-ai-frontend-ai-2025-02-16-09_06_47-0dXi2dmurnYMLJ8VQaN64s2E5qcB6O.png"
            alt="Beauty Products"
            width={600}
            height={400}
      ...
      {/* Featured Products - Now with lazy loading */}
      ...
      {/* Testimonials - Improved grid layout */}
